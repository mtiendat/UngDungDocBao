 ...
 */
public class KhoaHoc extends Fragment implements LoaderManager.LoaderCallbacks<List<Newspaper>>{
     ...
     * @return A new instance of fragment KhoaHoc.
     */
    ...
    public Loader<List<Newspaper>> onCreateLoader(int id, @Nullable Bundle args) {
        return new NewsPaperLoader(getContext(),"6");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=view.findViewById(R.id.recyclerview_khoahoc);
        mAdapter=new NewspaperAdapter(getContext(),listNews);
        recyclerView.setAdapter(mAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        loaderManager = LoaderManager.getInstance(this);
        Loader loader = loaderManager.getLoader(1000);
        final SwipeRefreshLayout pullToRefresh = view.findViewById(R.id.refreshKhoaHoc);
