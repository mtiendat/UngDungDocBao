 ...
 */
public class GiaiTri extends Fragment implements LoaderManager.LoaderCallbacks<List<Newspaper>>{
    ...
    public Loader<List<Newspaper>> onCreateLoader(int id, @Nullable Bundle args) {
        return new NewsPaperLoader(getContext(),"5");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        StartLoader();
        final SwipeRefreshLayout pullToRefresh = view.findViewById(R.id.refreshGiaiTri);
